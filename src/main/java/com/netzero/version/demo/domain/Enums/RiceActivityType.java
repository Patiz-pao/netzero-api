...
public enum RiceActivityType {
    ...
    HARROW_FIRST_AND_PUMPING_WATER_FIRST("คราด (ครั้งที่ 1) และ สูบน้ำ (ครั้งที่ 1)","ใช้คราดดินปรับหน้าดินให้เรียบเสมอ ทำทันทีหลังการไถแปร (1-2 วันก่อนหว่านเมล็ด) และ ใช้เครื่องสูบน้ำไฟฟ้า สูบน้ำเข้านาให้ดินชุ่มชื้น ระดับน้ำ 3-5 ซม.", USE_TRACTOR + USE_WATER_PUMP, 1),
