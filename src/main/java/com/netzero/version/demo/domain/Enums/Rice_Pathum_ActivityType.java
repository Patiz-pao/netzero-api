...
public enum Rice_Pathum_ActivityType implements RiceActivityType {
    ...
    Rice_Pathum_ActivityType(String name, String description, double baseElectricityRequired, int duration) {
        this.name = name;
