...
public enum Rice_RD57_ActivityType implements RiceActivityType {
    ...
    DRONE_FIRST("ช่วงการหว่านเมล็ดพันธุ์","ใช้โดรนหว่านเมล็ดพันธุ์ (ครั้งที่1) หว่านเมล็ดพันธุ์ กข57 ใช้เมล็ดพันธุ์ที่แช่น้ำและพักจนรากเริ่มงอก หว่านด้วยโดรนหว่านเมล็ดพันธุ์", USE_DRONE,1),
    RICE_TIMES("ช่วงรอข้าวแตกกอ","หากน้ำแห้ง ควรสูบน้ำเติมเพื่อป้องกันไม่ให้ข้าวขาดน้ำ แต่ไม่ควรปล่อยให้น้ำขังลึกเกินไป",0,6),
    RICE_PUMPING_WATER("ช่วงการดูแลต้นข้าว","รักษาระดับน้ำในนา 3 - 5 ซม. ตลอดระยะการเจริญเติบโต สูบน้ำเข้านา (ครั้งที่ 2) หลังหว่าน 7 วัน เพื่อกระตุ้นการงอก", USE_WATER_PUMP,1),
    ...
    RICE_TIMES_SIX("เตรียมเข้าสู่ช่วงข้าวตั้งท้อง", "เป็นช่วงที่ต้นข้าวเริ่มสร้างรวงข้าวภายในลำต้น ก่อนที่จะออกรวงให้เห็น",0,8),
    ...
    RICE_TIMES_ELEVEN("ช่วงระยะข้าวออกรวง","ห้ามปล่อยให้นาแห้งในช่วงนี้ เพราะอาจทำให้เมล็ดลีบหรือพัฒนาไม่สมบูรณ์",0,9),
    ...
    RICE_TIMES_TWELVE("ช่วงระยะข้าวออกรวงใกล้ระยะสุกแก่","เฝ้าระวังศัตรูพืช เช่น เพลี้ยกระโดด หนอนกอ และโรคเมล็ดด่าง",0,9),
    PUMPING_WATER_ELEVEN("สูบน้ำเข้านา (ครั้งที่ 11)","ใช้เครื่องสูบน้ำไฟฟ้า สูบน้ำเข้านาให้ดินชุ่มชื้น ระดับน้ำ 3-5 ซม.",USE_WATER_PUMP,1),
    RICE_TIMES_THIRTEEN("ช่วงระยะข้าวสุกแก่","เมล็ดข้าวเปลี่ยนสีจากเขียวเป็นเหลืองทอง รวงข้าวเอนลงจากน้ำหนักเมล็ดที่เต็มสมบูรณ์ ปลายของรวงข้าวแห้งและกรอบ",0,10),
