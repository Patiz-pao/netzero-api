...
public enum Rice_RD61_ActivityType implements RiceActivityType {
    ...
    HARROW_FIRST("คราด","ใช้คราดดินปรับหน้าดินให้เรียบเสมอ ทำทันทีหลังการไถแปร (1-2 วันก่อนหว่านเมล็ด) ", USE_TRACTOR, 1),
    PUMPING_WATER_FIRST("สูบน้ำ (ครั้งที่ 1)","ใช้เครื่องสูบน้ำไฟฟ้า สูบน้ำเข้านาให้ดินชุ่มชื้น ระดับน้ำ 3-5 ซม.", USE_WATER_PUMP, 1),
